...
typedef unsigned short	 int  LPC_INT16U;                 
typedef signed    short  int  LPC_INT16S;                
typedef unsigned 		 int    LPC_INT32U;                 
typedef signed   		 int     LPC_INT32S;                 

#define LPC_STATUS      unsigned int
